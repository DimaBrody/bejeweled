...
public class StateGame extends State {
    ...
    private BitmapFont _fontScores;
    ...
    public void load() {
        ...
        _fontScores = Freegemas.getPlatformResolver().loadFont("data/normalFont.fnt", "data/normal.ttf", 30);
...
//            _song.play();
    ...
    public void render() {
        ...
        // Draw the score
        _fontText.draw(batch, _lang.getString("Points"), 0, 40);
        ...
        _fontText.draw(batch, _lang.getString("Time left"), 0, 180);
        ...
        _fontText.draw(batch, "Scores", 0, 330);

        _fontScores.draw(batch,
                scores,
                0,
                380);
